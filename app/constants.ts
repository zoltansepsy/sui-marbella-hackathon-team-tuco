 ...
 * Deploy with: cd move/startHack && sui client publish --gas-budget 100000000 .
 */
 ...
 * Uses same package as job_escrow (part of startHack package)
 */
...
// 1. Deploy contracts: cd move/startHack && sui client publish --gas-budget 100000000 .
